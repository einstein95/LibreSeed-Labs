...
const results: Dictionary[String, String] = {
    "array_bool": "hashmap_bool",
    "array_int": "hashmap_int",
    "array_float": "hashmap_float",
    "array_char": "hashmap_char",
    "array_bitflag": "hashmap_bitflag",
    "array_bigint": "hashmap_bigint",
    "array_decimal": "hashmap_decimal",
    "array_string": "hashmap_string",
