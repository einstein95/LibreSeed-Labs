...
func get_visibility() -> bool:
    ...
    if maxed:
        return get_visibility_maxed()

    if Globals.money_level < Data.upgrades[name].level:
        return false
...
func get_visibility_maxed() -> bool:
    if Data.upgrades[name].category != "main":
        return true
...
func can_purchase() -> bool:
    ...
    if cost > Globals.currencies[Data.upgrades[name].currency]:
        return false
